...
export class PuzzleShapeGenerator {
    ...
    createEdgePath(x1, y1, x2, y2, isTab, tabSize, orientation) {
        ...
        // Make tabs even more pronounced for smaller pieces
        const tabDepth = length * 0.42; // Increased to 0.42 for very prominent tabs
        const neckWidth = 0.22; // Narrower neck for more defined shape
